...
<svelte:head>
	<title>Tambah Pengeluaran | Keuangan | MiniMasjid</title>
</svelte:head>

<div class="max-w-2xl mx-auto space-y-6">
	<!-- Header -->
	<div class="flex items-center gap-4">
		<a href="/keuangan/pengeluaran" class="btn btn-ghost btn-sm btn-square">
			<ArrowLeft class="w-5 h-5" />
		</a>
		<div>
			<h1 class="text-2xl font-bold">➖ Tambah Pengeluaran</h1>
			<p class="text-base-content/60">Catat pengeluaran baru dari kas masjid</p>
		</div>
	</div>
	...
	>
		<div class="card-body space-y-4">
			...
			<div class="form-control">
				<label class="label">
					<span class="label-text">Bukti/Nota (opsional)</span>
				</label>
				<input
					type="file"
					name="receipt"
			...
			<div class="flex justify-end gap-2 pt-4 border-t border-base-200">
				<a href="/keuangan/pengeluaran" class="btn btn-ghost">
					<X class="w-4 h-4" />
					Batal
				</a>
